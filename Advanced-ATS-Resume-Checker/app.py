...
def get_gemini_output(resume_text, job_description, analysis_type):
    ...
    if analysis_type == "Quick Scan":
        if job_description:
            ...
            5. Give an overall ATS score out of 100 with respect to the job description. Title for this point in this format(Overall ATS Score (out of 100): score)
        ...
        if job_description:
            ...
            7. Give an overall ATS score out of 100 with respect to the job description. Title for this point in this format(Overall ATS Score (out of 100): score)
        ...
        if job_description:
            ...
            6. Give an overall ATS score out of 100 with respect to the job description. Title for this point in this format(Overall ATS Score (out of 100): score)
